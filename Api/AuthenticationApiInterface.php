...
interface AuthenticationApiInterface
{
   ...
   */
  public function authenticateDelete(int &$responseCode, array &$responseHeaders): void;
   ...
   * @param array $responseHeaders Additional HTTP headers to return with the response ()
   */
  public function authenticateGet(int &$responseCode, array &$responseHeaders): void;
   ...
   */
  public function authenticatePost(Login $login, int &$responseCode, array &$responseHeaders): JWTTokenResponse;
}
