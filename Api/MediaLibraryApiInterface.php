...
interface MediaLibraryApiInterface
{
   ...
   * @return OpenAPI\Server\Model\MediaFileResponse[]
   */
  public function mediaFilesGet(int $limit = 20, int $offset = 0, Flavor $flavor = null, &$responseCode, array &$responseHeaders);
   ...
   * @return OpenAPI\Server\Model\MediaFileResponse[]
   */
  public function mediaFilesSearchGet(string $query, Flavor $flavor = null, int $limit = 20, int $offset = 0, string $package_name = null, &$responseCode, array &$responseHeaders);
