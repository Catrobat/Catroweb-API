...
interface ProjectsApiInterface
{
     ...
     *
     */
    public function projectsFeaturedGet($platform = null, $maxVersion = null, $limit = 20, $offset = 0, $flavor = ''pocketcode'', &$responseCode, array &$responseHeaders);
     ...
     *
     */
    public function projectsMostDownloadedGet($maxVersion = null, $limit = 20, $offset = 0, $flavor = ''pocketcode'', &$responseCode, array &$responseHeaders);
     ...
     *
     */
    public function projectsMostViewedGet($maxVersion = null, $limit = 20, $offset = 0, $flavor = ''pocketcode'', &$responseCode, array &$responseHeaders);
     ...
     *
     */
    public function projectsRandomProgramsGet($maxVersion = null, $limit = 20, $offset = 0, $flavor = ''pocketcode'', &$responseCode, array &$responseHeaders);
     ...
     *
     */
    public function projectsRecentGet($maxVersion = null, $limit = 20, $offset = 0, $flavor = ''pocketcode'', &$responseCode, array &$responseHeaders);
     ...
     *
     */
    public function projectsSearchGet($maxVersion = null, $limit = 20, $offset = 0, $flavor = ''pocketcode'', &$responseCode, array &$responseHeaders);
     ...
     * @param  string $flavor  Available flavors (optional, default to ''pocketcode'')
     * @param  OpenAPI\Server\Model\Tag[] $tags  Available tags (optional)
     * @param  integer $responseCode     The HTTP response code to return
     * @param  array   $responseHeaders  Additional HTTP headers to return with the response ()
     *
     * @return void
     *
     */
    public function projectsUploadPost($token, $checksum = null, UploadedFile $file = null, $flavor = ''pocketcode'', array $tags = null, &$responseCode, array &$responseHeaders);
