...
interface ProjectsApiInterface
{
   ...
   * @param OpenAPI\Server\Model\Flavor $flavor          (optional)
   * @param int                         $responseCode    The HTTP response code to return
   * @param array                       $responseHeaders Additional HTTP headers to return with the response ()
   *
   * @return OpenAPI\Server\Model\FeaturedProjectResponse[]
   */
  public function projectsFeaturedGet(string $platform = null, string $max_version = null, int $limit = 20, int $offset = 0, Flavor $flavor = null, &$responseCode, array &$responseHeaders);
   ...
   * @return OpenAPI\Server\Model\ProjectResponse[]
   */
  public function projectsGet(string $project_type, string $accept_language = null, string $max_version = null, int $limit = 20, int $offset = 0, Flavor $flavor = null, &$responseCode, array &$responseHeaders);
   ...
   * @return array
   */
  public function projectsPost(string $checksum, UploadedFile $file, string $accept_language = null, Flavor $flavor = null, bool $private = null, &$responseCode, array &$responseHeaders);
   ...
   * @return OpenAPI\Server\Model\ProjectResponse[]
   */
  public function projectsSearchGet(string $query, string $max_version = null, int $limit = 20, int $offset = 0, Flavor $flavor = null, &$responseCode, array &$responseHeaders);
   ...
   * @return OpenAPI\Server\Model\ProjectResponse[]
   */
  public function projectsUserGet(string $max_version = null, int $limit = 20, int $offset = 0, Flavor $flavor = null, &$responseCode, array &$responseHeaders);
   ...
   * @return OpenAPI\Server\Model\ProjectResponse[]
   */
  public function projectsUserIdGet(string $id, string $max_version = null, int $limit = 20, int $offset = 0, Flavor $flavor = null, &$responseCode, array &$responseHeaders);
}
