...
interface SecurityApiInterface
{
     ...
     * @param  OpenAPI\Server\Model\InlineObject $inlineObject   (required)
     ...
     *
     */
    public function checkTokenPost($token, InlineObject $inlineObject, &$responseCode, array &$responseHeaders);
