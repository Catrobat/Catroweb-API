...
class NotificationsController extends Controller
{
    ...
    public function notificationIdReadPutAction(Request $request, $id)
    {
        ...
        try {
            ...
            $responseCode = 204;
            $responseHeaders = [];
            $result = $handler->notificationIdReadPut($id, $accept_language, $responseCode, $responseHeaders);
    ...
    public function notificationsGetAction(Request $request)
    {
        ...
        try {
            ...
            $type = $this->deserialize($type, 'NotificationsType', 'string');
        } catch (SerializerRuntimeException $exception) {
            return $this->createBadRequestResponse($exception->getMessage());
        }
        ...
        $asserts = [];
        $asserts[] = new Assert\Type("NotificationsType");
