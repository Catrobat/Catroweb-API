...
class ProjectsController extends Controller
{
    ...
    public function projectsFeaturedGetAction(Request $request)
    {
        ...
        try {
            ...
            $responseCode = 200;
            $responseHeaders = [];
            $result = $handler->projectsFeaturedGet($platform, $maxVersion, $limit, $responseCode, $responseHeaders);
    ...
    public function projectsMostDownloadedGetAction(Request $request)
    {
        ...
        try {
            ...
            $responseCode = 200;
            $responseHeaders = [];
            $result = $handler->projectsMostDownloadedGet($maxVersion, $limit, $offset, $responseCode, $responseHeaders);
    ...
    public function projectsMostViewedGetAction(Request $request)
    {
        ...
        try {
            ...
            $responseCode = 200;
            $responseHeaders = [];
            $result = $handler->projectsMostViewedGet($maxVersion, $limit, $offset, $responseCode, $responseHeaders);
    ...
    public function projectsRandomProgramsGetAction(Request $request)
    {
        ...
        try {
            ...
            $responseCode = 200;
            $responseHeaders = [];
            $result = $handler->projectsRandomProgramsGet($maxVersion, $limit, $offset, $responseCode, $responseHeaders);
    ...
    public function projectsRecentGetAction(Request $request)
    {
        ...
        try {
            ...
            $responseCode = 200;
            $responseHeaders = [];
            $result = $handler->projectsRecentGet($maxVersion, $limit, $offset, $responseCode, $responseHeaders);
    ...
    public function projectsSearchGetAction(Request $request)
    {
        ...
        try {
            ...
            $responseCode = 200;
            $responseHeaders = [];
            $result = $handler->projectsSearchGet($query, $maxVersion, $limit, $offset, $responseCode, $responseHeaders);
    ...
    public function projectsUploadPostAction(Request $request)
    {
        ...
        try {
            ...
            $flavor = $this->deserialize($flavor, 'OpenAPI\Server\Model\Flavor', 'string');
        ...
        $asserts = [];
        $asserts[] = new Assert\Type("OpenAPI\Server\Model\Flavor");
        ...
        try {
            ...
            $responseCode = 204;
            $responseHeaders = [];
            $result = $handler->projectsUploadPost($token, $flavor, $checksum, $file, $responseCode, $responseHeaders);
