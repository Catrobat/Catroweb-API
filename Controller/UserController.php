...
class UserController extends Controller
{
    ...
    public function userPutAction(Request $request)
    {
        ...
        // Read out all input parameter values into variables
        $accept_language = $request->headers->get('Accept-Language');
        $update_user = $request->getContent();
        ...
        try {
            $inputFormat = $request->getMimeType($request->getContentType());
            $update_user = $this->deserialize($update_user, 'OpenAPI\Server\Model\UpdateUser', $inputFormat);
            $accept_language = $this->deserialize($accept_language, 'string', 'string');
        } catch (SerializerRuntimeException $exception) {
            return $this->createBadRequestResponse($exception->getMessage());
        }
        ...
        $asserts = [];
        $asserts[] = new Assert\NotNull();
        $asserts[] = new Assert\Type("OpenAPI\Server\Model\UpdateUser");
        $asserts[] = new Assert\Valid();
        $response = $this->validate($update_user, $asserts);
        if ($response instanceof Response) {
            return $response;
        }
        $asserts = [];
        ...
        try {
            ...
            $responseCode = 204;
            $responseHeaders = [];
            $result = $handler->userPut($update_user, $accept_language, $responseCode, $responseHeaders);
