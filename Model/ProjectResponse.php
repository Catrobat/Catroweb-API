...
class ProjectResponse
{
   ...
   * @Type("float")
   */
  protected ?float $not_for_kids = null;
   ...
   * Gets not_for_kids.
   */
  public function getNotForKids(): ?float
  {
   ...
   * Sets not_for_kids.
   *
   * @param float|null $not_for_kids Indicates whether a project is suitable for kids or not (0 = safe for kids, 1 = not safe for kids, 2 = not safe for kids set by moderator)
   *
   * @return $this
   */
  public function setNotForKids(?float $not_for_kids = null): self
  {
