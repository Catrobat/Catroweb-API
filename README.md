...
*AuthenticationApiInterface* | [**authenticationUpgradePost**](Resources/docs/Api/AuthenticationApiInterface.md#authenticationupgradepost) | **POST** /authentication/upgrade | Upgrade a deprecated token -- StatusCode: 501 - Not yet implemented
