...
*AuthenticationApiInterface* | [**authenticationLogoutPost**](Resources/docs/Api/AuthenticationApiInterface.md#authenticationlogoutpost) | **POST** /authentication/logout | Expires refresh token
