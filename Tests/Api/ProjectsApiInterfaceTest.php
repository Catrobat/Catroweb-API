...
class ProjectsApiInterfaceTest extends WebTestCase
{
     ...
     *
     */
    public function testProjectIdCatrobatGet()
    {
        $client = self::$client;
     ...
     *
     */
    public function testProjectIdDelete()
    {
        $client = self::$client;
     ...
     *
     */
    public function testProjectIdPut()
    {
        $client = self::$client;
     ...
     *
     */
    public function testProjectIdRecommendationsGet()
    {
        $client = self::$client;
     ...
     *
     */
    public function testProjectsCategoriesGet()
    {
        $client = self::$client;
     ...
     *
     */
    public function testProjectsExtensionsGet()
    {
        $client = self::$client;
     ...
     *
     */
    public function testProjectsTagsGet()
    {
        $client = self::$client;
