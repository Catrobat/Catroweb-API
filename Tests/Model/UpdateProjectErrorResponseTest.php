 ...
 * @see        https://github.com/openapitools/openapi-generator
 *
 * @coversDefaultClass \OpenAPI\Server\Model\UpdateProjectErrorResponse
 *
 * @internal
 */
class UpdateProjectErrorResponseTest extends TestCase
{
  ...
  {
    $this->object = $this->getMockBuilder(UpdateProjectErrorResponse::class)->getMockForAbstractClass();
  }
  ...
  {
    $this->assertTrue(class_exists(UpdateProjectErrorResponse::class));
    $this->assertInstanceOf(UpdateProjectErrorResponse::class, $this->object);
  }
